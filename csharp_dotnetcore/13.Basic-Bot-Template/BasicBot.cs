...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class BasicBot : IBot
    {
        ...
        public BasicBot(UserState userState, ConversationState conversationState, BotServices services, ILoggerFactory loggerFactory)
        {
            ...
            _dialogs = new DialogSet(this.ConversationState.CreateProperty<DialogState>(nameof(BasicBot)));
            _dialogs.Add(new MainDialog(services, this.UserState, this.ConversationState, loggerFactory));
        }
